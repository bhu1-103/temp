...
for in_file, out_file in zip(input_files, output_files):
    ...
    X = X.drop(columns=['is_ap'])
    X = X.drop(columns=['max_channel_allowed'])
    #X = X.drop(columns=['min_channel_allowed'])
    #X = X.drop(columns=['primary_channel'])
